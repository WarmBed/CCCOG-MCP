...
| 11 | Completion surfacing | **DONE 2026-09-06.** State hook lists jobs completed since the session's previous turn (per-session cursor) and unread inbox notes. True wake-up of an idle session remains impossible from CCCG's side. |
